...
def main():
    ...
    all_subs = [403, 404, 405, 406, 407, 410, 411]
    ...
    for sub in all_subs:  #'CN', 'CL','TN', 'TL'
        ...
        for condition in CONDITION_LABELS: #CONDITION_LABELS
            ...
            for optimal_input in ['RL', 'RN']:
                ...
                temp_ev_array  = get_EV_array(temp_std, condition, graph_input, optimal_input, loss_aversion_score)
                ...
                #create_EV_landscape(temp_ev_array, condition, temp_output_directory, optimal_input, subject) #,opt_ev
