...
ZERO_SMALL_LABEL       = '32,0'
SMALL_SMALL_LABEL      = '32,1'
MULT_SMALL_SMALL_LABEL = '32,3'
LARGE_SMALL_LABEL      = '32,5'
MULT_LARGE_SMALL_LABEL = '32,15'
ZERO_LARGE_LABEL       = '44,0'
SMALL_LARGE_LABEL      = '44,1'
MULT_SMALL_LARGE_LABEL = '44,3'
LARGE_LARGE_LABEL      = '44,5'
MULT_LARGE_LARGE_LABEL = '44,15'

CONDITION_LABELS = [ZERO_SMALL_LABEL, ZERO_LARGE_LABEL, SMALL_SMALL_LABEL, SMALL_LARGE_LABEL, MULT_SMALL_SMALL_LABEL, MULT_SMALL_LARGE_LABEL, LARGE_SMALL_LABEL, LARGE_LARGE_LABEL, MULT_LARGE_SMALL_LABEL, MULT_LARGE_LARGE_LABEL]
...
#Optimal model input codes
LOSS_AVERSION_MODELS = ['CL', 'RL', 'TL']
MODEL_CODES          = ['CN', 'CL', 'RN', 'RL', 'TN', 'TL']
...
OUTER_PEN_LIM_LARGE = -32
OUTER_PEN_LIM_SMALL = -32
OUTER_REW_LIM       = 32

SIM_GRID_HORIZ_MAX        =  OUTER_REW_LIM    #32 pixels past #OUTER_REW_LIM + 5 #5 pixels past outer rew limit
SIM_GRID_HORIZ_MIN_LARGE  = -OUTER_REW_LIM #OUTER_PEN_LIM_LARGE - 5 #5 pixels past large outer pen limit 
SIM_GRID_HORIZ_MIN_SMALL  = -OUTER_REW_LIM #OUTER_PEN_LIM_SMALL - 5 #5 pixels past small outer pen limit 

LARGE_GRID_WIDTH = SIM_GRID_HORIZ_MAX - SIM_GRID_HORIZ_MIN_LARGE
SMALL_GRID_WIDTH = SIM_GRID_HORIZ_MAX - SIM_GRID_HORIZ_MIN_SMALL
...
SIM_GRID_VERT_MAX   = 32 #[-20, -15, -10, -5 , 0, 5 , 10, 15, 20, 30, 35]
